"""
TFDS/RLDS dataset builder for the BridgeV2 10K subset.

Reads from both real_5k_1 and real_5k_2 (parquet + individual mp4 per episode)
and produces a single RLDS dataset compatible with Octo's data pipeline.
"""
...
_DESCRIPTION = "BridgeV2 10K episode subset (real_5k_1 + real_5k_2) for Octo training."

_BASE_DIR = "/prj/corp/airesearch/lasvegas/vol5-scratch/users/phongnh/Long/data/bridgeV2"
_DEFAULT_DATA_DIRS = [
    os.path.join(_BASE_DIR, "real_5k_1"),
    os.path.join(_BASE_DIR, "real_5k_2"),
]


class Builder(tfds.core.GeneratorBasedBuilder):
    """TFDS builder for BridgeV2 10K subset."""

    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {"1.0.0": "Initial 10K subset (5K+5K)."}
