"""
TFDS/RLDS dataset builder for the synthetic 1K subset (sim_1k_1).

Mirrors sim10k_dataset but reads only sim_1k_1.
"""
...
_DESCRIPTION = "Synthetic 1K episode subset (sim_1k_1) for Octo training."

_BASE_DIR = "/prj/corp/airesearch/lasvegas/vol5-scratch/users/phongnh/Long/data/bridgeV2"
_DEFAULT_DATA_DIRS = [
    os.path.join(_BASE_DIR, "sim_1k_1"),
]


class Builder(tfds.core.GeneratorBasedBuilder):
    """TFDS builder for synthetic 1K subset."""

    VERSION = tfds.core.Version("1.0.0")
    RELEASE_NOTES = {"1.0.0": "Initial synthetic 1K subset (sim_1k_1)."}
